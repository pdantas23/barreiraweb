// Fica fora de app/ (que é a pasta de rotas do Expo Router — tudo lá vira
// route e entra no bundle). Aqui em src/__tests__ o Jest acha (testMatch
// cobre src/**) mas o Metro/Expo Router não bundla.
...
jest.mock("../hooks/useButtonSound", () => ({ playButtonSound: jest.fn(), useButtonSound: jest.fn() }));
